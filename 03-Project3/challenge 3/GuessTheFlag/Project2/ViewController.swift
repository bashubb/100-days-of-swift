...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: isScoreShown ? "Score: \(score)" : "Show score" , style: .plain, target: self, action: #selector(showScore))
    }
    ...
    func updateUI() {
        title = "\(countries[correctAnswer].uppercased()) - Question: \(currentQuestion)/\(maxQuestion)"
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: isScoreShown ? "Score: \(score)" : "Show score" , style: .plain, target: self, action: #selector(showScore))
    }
